...
var ChangesListener = function () {
  ...
  _createClass(ChangesListener, [{
      ...
      if (isBody === false) {
        ...
        switch (event) {
          ...
          case 'children_change':
            ...
            break;
          default:
            (0, _utils.showError)('\u041D\u0435 \u043F\u043E\u043F\u0430\u043B \u043F\u043E\u0434 \u0443\u0441\u043B\u043E\u0432\u0438\u044F: ' + this.selector + ' - ' + event);
            return;
          // break;
        }
        ...
        var _observer = new MutationObserver(function (mutations, context) {
          switch (event) {
            ...
            case 'hide':
              ...
              break;
            default:
              (0, _utils.showError)('\u041D\u0435 \u043F\u043E\u043F\u0430\u043B \u043F\u043E\u0434 \u0443\u0441\u043B\u043E\u0432\u0438\u044F: ' + _this.selector + ' - ' + _this.event);
    ...
    value: function disconnectListener() {
      ...
      if (!listener) {
        (0, _utils.showError)('Listener \u0441 id ' + this.listener_id + ' \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D');
        return;
      }
...
exports.default = ChangesListener;
'use strict';
...
var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; /* eslint-disable prefer-rest-params */
/* eslint-disable no-underscore-dangle */
...
var _introChat = require('./intro-chat');

var _introChat2 = _interopRequireDefault(_introChat);

var _ChangesListener = require('./ChangesListener');

var _ChangesListener2 = _interopRequireDefault(_ChangesListener);
...
var onboarding = {
  ...
  __listenForObserveRequests: function __listenForObserveRequests(e) {
    if (isMessageFromWidget(e) && e.data.action === 'OBSERVE') {
      var listener = new _ChangesListener2.default(e.data);
  ...
  renderWidget: function renderWidget(widgetUrl) {
    ...
    var widgetHtml = '<button type="button" class="getchat-widget__btn--icon" >' + '<i aria-hidden="true" class="getchat-widget__icon--close"></i></button>' + ('<iframe src="' + widgetUrl + '" class="getchat-widget__frame"></iframe>');
  ...
  loadWidgetData: function loadWidgetData() {
    ...
    var url = 'http://localhost:3000/api/the-bot/widget/' + this.hash + '/data';
    ...
    return new Promise(function (resolve, reject) {
      return fetch(url, {
        ...
        (0, _utils.showError)('[\u041E\u0448\u0438\u0431\u043A\u0430] ' + res.statusText);
        return {};
...
(function (f) {
  ...
  function _setClipPathOfHelper(helperLayer) {
    ...
    if (step.fixed) {
      ...
      if (overlay) {
        overlay.style.clipPath = 'polygon(' + coords.map(function (_ref) {
          var x = _ref.x,
              y = _ref.y;
          return x + ' ' + y;
        }).join(', ') + ')';
