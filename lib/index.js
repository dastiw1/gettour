  ...
  _createClass(ConditionEventsListeners, [{
    ...
    value: function start() {
      ...
      this.filterByPath(this.autoConditions, true).forEach(function (uuid) {
        ...
        if (_this4.active !== uuid && prevPath !== path && _this4.matchDate(cond)) {
