...
var _default = {
  ...
  __setConditionAlignment: function __setConditionAlignment(uuid, alignment) {
    if (this.autoShowConditions[uuid]) {
      this.autoShowConditions[uuid].options.alignment = alignment;
    } else {
      (0, _utils.showError)("Can't set condition alignment. Condition with UUID ".concat(uuid, " is not found"));
    }
  },
