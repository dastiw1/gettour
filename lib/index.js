...
/*!**********************!*\
  !*** ./package.json ***!
  \**********************/
/*! exports provided: name, version, description, main, files, scripts, repository, keywords, author, license, bugs, homepage, devDependencies, nyc, dependencies, default */
/***/ (function(module) {

module.exports = {"name":"gettour","version":"0.6.0","description":"Getchat.me onboarding tour library that works with their autochats","main":"lib/gettour.js","files":["src","lib/gettour.js","lib/gettour.min.js","lib/index.js","lib/gettour.js.map","lib/index.min.js.map","lib/index.js.map","dist"],"scripts":{"build":"npm run build:css && webpack --env dev && webpack --env build && npm run test","dev":"webpack --progress --colors --watch --env dev","test":"mocha --require babel-register --colors ./test/*.spec.js","test:watch":"mocha --require babel-register --colors -w ./test/*.spec.js","test:cover":"cross-env NODE_ENV=test nyc mocha --require babel-register --colors test/*.js","repl":"node -i -e \"$(< ./lib/gettour.js)\"","scss":"node-sass -o dist/css src/scss/styles.scss","cssmin":"cleancss -o dist/css/styles.min.css dist/css/styles.css","build:css":"npm run scss && npm run cssmin"},"repository":{"type":"git","url":"https://github.com/dastiw1/gettour.git"},"keywords":["webpack","es6","starter","library","universal","umd","commonjs"],"author":"Dastan Mukazhan <seer.dastan@gmail.com>","license":"MIT","bugs":{"url":"https://github.com/dastiw1/gettour/issues"},"homepage":"https://github.com/dastiw1/gettour","devDependencies":{"@babel/cli":"^7.0.0-beta.51","@babel/core":"^7.0.0-beta.51","@babel/preset-env":"^7.0.0-beta.51","babel-eslint":"^8.0.3","babel-loader":"^8.0.0-beta.4","babel-plugin-add-module-exports":"^0.2.1","babel-plugin-istanbul":"^5.1.0","babel-preset-env":"^7.0.0-beta.3","babel-register":"^7.0.0-beta.3","chai":"^4.1.2","clean-css-cli":"^4.3.0","cross-env":"^5.2.0","eslint":"^5.0.1","eslint-loader":"^2.0.0","jsdom":"11.11.0","jsdom-global":"3.0.2","mocha":"^4.0.1","mustache-loader":"^1.4.3","node-sass":"^4.12.0","nyc":"^13.1.0","uglifyjs-webpack-plugin":"^1.2.7","webpack":"^4.12.2","webpack-cli":"^3.0.8","yargs":"^10.0.3"},"nyc":{"sourceMap":false,"instrument":false},"dependencies":{"@popperjs/core":"^2.0.5","js-cookie":"^2.2.1","mustache":"^3.1.0"}};
...
function () {
  ...
  _createClass(EventBus, [{
    ...
    value: function clearListeners() {
      var newBus = this.bus.cloneNode(true);

      try {
        this.busParent.replaceChild(newBus, this.bus);
      } catch (error) {
        (0, _utils.showError)("[Error in EventBus.clearListeners method] ".concat(error.message));
      }
    }
  }]);
...
var EXPAND_COOKIE_KEY = 'gw-state'; // Private variables

var _LOCALSTORAGE_KEY = 'WIDGET_WINDOW_VALIDATION';
...
var _onWindowUpdated; // Remove the window from the global count
...
function removeWindow() {
  ...
  if (_jsCookie.default.get(EXPAND_COOKIE_KEY) !== 'true' && __windowArray.length < 1) {
    _jsCookie.default.set(EXPAND_COOKIE_KEY, true, {
      expires: 2147483647
    });
  }
...
function () {
  ...
  _createClass(WindowStateManager, [{
    key: "getWindowsArray",
    value: function getWindowsArray() {
      return _windowArray;
    }
    /** Determine the state of the window If its a main or child window */

  }, {
    key: "determineWindowState",
    value: function determineWindowState() {
      var _this = this;
      ...
      setTimeout(function () {
        _this.determineWindowState();
      }, RECHECK_WINDOW_DELAY_MS);
    }
  }, {
    key: "isMainWindow",
    value: function isMainWindow() {
      return _isMainWindow;
    }
  }, {
    key: "resetWindows",
    value: function resetWindows() {
...
var _default = WindowStateManager;
exports.default = _default;
module.exports = exports["default"];
...
var _default = {
  ...
  changeWidgetAlignment: function changeWidgetAlignment(alignment) {
    ...
    var uuid = this.active.condition;
    ...
    this.block.classList.add("".concat(classPrefix, "--").concat(alignment)); // save conditions as options
...
var _WindowStateManager = _interopRequireDefault(__webpack_require__(/*! ./WindowStateManager */ "./src/WindowStateManager.js"));
...
var _DispatcherEvent = _interopRequireDefault(__webpack_require__(/*! ./DispatcherEvent */ "./src/DispatcherEvent.js"));
...
var CDN_BASEPATH = 'https://cdn.jsdelivr.net/npm/gettour';
var STYLEPATH = {
  development: 'http://gettour/dist/css/styles.css',
  production: "".concat(CDN_BASEPATH, "@").concat(VERSION, "/dist/css/styles.min.css")
};
/**
...
var onboarding = Object.assign({
  ...
  init: function init(hash) {
    ...
    if (this.options.mobile === false && (0, _utils.isMobileDevice)()) {
      return false;
    }
    ...
    if (this.windowStateManager == null) {
      this.windowStateManager = new _WindowStateManager.default(false, function () {});
    }

    return this;
  },
  startInitialize: function startInitialize() {
    var _this2 = this;
    ...
    if (data !== null) {
      if (Object.keys(data.conditions).length === 0) {
        (0, _utils.showError)('ERROR! Widget data not recieved!');
        return;
      }

      this.domain = data.domain;
      this.active.status = data.widget_active; // this.options = Object.assign(this.options, data.widget_options);

      if ((0, _utils.isObject)(data.widget_options)) {
        Object.keys(data.widget_options).forEach(function (key) {
          _this2.options[key] = data.widget_options[key];
        });
      }

      Object.keys(data.conditions).forEach(function (key) {
        data.conditions[key] = Object.assign({
          options: {
            alignment: _this2.options.alignment
          }
        }, data.conditions[key]);
      });
    ...
    this.__intro = (0, _introChat.default)();
    this.ConditionEventsListeners = new _ConditionEventsListeners.default(this.autoShowConditions);
    this.ConditionEventsListeners.watchForMatch(true);

    this.__intro.onchange(function () {
      self.__intro.refresh();

      return _this2;
    });

    this.__intro.onbeforechange(function () {
      if (_this2.__intro._introItems.length) {
        var step = _this2.__intro._introItems[0];
    ...
    window.getTourEventBus.addEventListener('ConditionMatched', this.conditionMatchHandler); // Если не подходит под условия
  ...
  conditionMatchHandler: function conditionMatchHandler(e) {
    var self = window.gettour;

    if (e != null && self.autoShowConditions[e.detail.uuid] && self.autoShowConditions[e.detail.uuid].onClick && self.active.condition === e.detail.uuid && self.active.condition) {
  ...
  loadCondition: function loadCondition(uuid) {
    ...
    if (this.active.condition) {
      ...
      var asExpanded = oldVal === 'true' || typeof oldVal === 'undefined';
  ...
  listenForLocationChange: function listenForLocationChange() {
    ...
    window.addEventListener('locationchange', function () {
      clearInterval(_this3.ConditionEventsListeners.interval);

      _this3.reset();

      if (Object.keys(_this3.autoShowConditions).length) {
        _this3.ConditionEventsListeners.watchForMatch();
      }
    });
  },
  ...
  __listenForActionClickedRequests: function __listenForActionClickedRequests(e) {
    ...
    if (steps && steps.length && steps.find(function (s) {
      return s.highlightEventAnswerId === answer_id;
    })) {
  ...
  __listenForObserveRequests: function __listenForObserveRequests(e) {
    var data = e.data; // let activeListener = this.active.listenerId;
  ...
  __listenForUserScriptEvaluateRequests: function __listenForUserScriptEvaluateRequests(e) {
    var data = e.data; // eslint-disable-next-line no-eval
  ...
  __listenForDataLayerPushes: function __listenForDataLayerPushes(e) {
    if (e.data.payload) {
  ...
  highlight: function highlight(_ref2) {
    ...
    if (introElement == null) {
      (0, _utils.showError)("Element doesn't exist on DOM: ".concat(selector));
      return;
    }
    ...
    if (closeEvent !== 'chatListenerClick') {
      introElement.addEventListener(closeEvent, function () {
        _this4.__intro.exit(true);

        _this4.__intro.clearSteps();
      }, {
        once: true
      });
    } // Close
  ...
  destroyWidget: function destroyWidget() {
    var removeOldListeners = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
  ...
  __getAlignmentValue: function __getAlignmentValue() {
    var uuid = this.active.condition;
  ...
  renderWidget: function renderWidget(chatUrl, asExpanded) {
    ...
    if (this.options.alignment) {
      this.block.className += " ".concat(widgetClass, "--").concat(this.__getAlignmentValue());
    ...
    var _this$options = this.options,
        showOverlay = _this$options.showOverlay,
        hideCloseButton = _this$options.hideCloseButton;
    ...
    document.body.appendChild(this.block); // appending overlay

    var overlay = document.getElementsByClassName(this.overlayClass);
    ...
    var frame = document.querySelector('.getchat-widget__frame'); // Авторасскрытие

    frame.onload = function () {
      if (!_this5.block.classList.contains(_this5.expandClass) && asExpanded) {
        _this5.expandBlock();
      }
    }; // запуск слушателей
  ...
  loadChatBot: function loadChatBot(url) {
    ...
    this.hideBlock();
    setTimeout(function () {
      _this6.destroyWidget();

      _this6.renderWidget(url, expand);
    }, 500);
  },
  ...
  initSystemEventListeners: function initSystemEventListeners() {
    ...
    if (!this.options.hideCloseButton) {
      ...
      $closeBtn.addEventListener('click', function (event) {
        if (widget.classList.contains(_this7.expandClass)) {
          _this7.hideBlock(event);
        }
      });
    }
    ...
    $menuBtn.addEventListener('click', function () {
      _this7.showAvailableBots();
    });
    var $launcher = document.querySelector('.getchat-widget__launcher');
    $launcher.addEventListener('click', function (event) {
      if (!widget.classList.contains(_this7.expandClass)) {
        _this7.expandBlock(event);
      }
    });
    window.addEventListener('beforeunload', function () {
      clearInterval(_this7.ConditionEventsListeners.interval);
  ...
  hideBlock: function hideBlock() {
    ...
    var userClickEvent = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    // Передем в чат сообщение о состояний раскрытия виджета
    this.sendMessage({
      expanded: false
    }, 'expandStatus', false); // hide widget window

    this.block.classList.remove(this.expandClass); // hide overlay

    this.overlay.style.display = 'none'; // expand cookie
  ...
  expandBlock: function expandBlock() {
    ...
    var userClickEvent = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    // show widget window
    this.block.classList.add(this.expandClass); // show overlay
  ...
  showAvailableBots: function showAvailableBots() {
    ...
    var answers = this.ConditionEventsListeners.filterByPath(this.autoShowConditions, true).map(function (uuid) {
      ...
      var _this10$autoShowCondi = _this10.autoShowConditions[uuid],
          bot_id = _this10$autoShowCondi.bot_id,
          name = _this10$autoShowCondi.name,
          lang = _this10$autoShowCondi.lang,
          start = _this10$autoShowCondi.start;
      return {
        answer: {
          answer_id: answer_id,
          bot_id: bot_id,
  ...
  on: function on(eventName, callback) {
    ...
    if (!event) {
      event = new _DispatcherEvent.default(eventName);
...
(function (f) {
  ...
  function _setHelperLayerPosition(helperLayer) {
    ...
    if (helperLayer) {
      ...
      window.setTimeout(function () {
        _setClipPathOfHelper.call(_this2, helperLayer);
      }, 35);
    }
  }
  /**
...
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<div class=\"getchat-widget__wrapper\">\r");t.b("\n" + i);t.b("  <div class=\"getchat-widget__content\">\r");t.b("\n" + i);t.b("    <div class=\"getchat-widget__header\" style=\"");t.b(t.v(t.d("styles.header",c,p,0)));t.b("\" >\r");t.b("\n" + i);t.b("      <div class=\"getchat-widget__header-ava\"><img src=\"/img/unknown_ava.jpg\" alt=\"widget avatar\"></div>\r");t.b("\n" + i);t.b("      <div class=\"getchat-widget__header-actions\">\r");t.b("\n" + i);t.b("        <div class=\"getchat-widget__btn getchat-widget__btn--action-menu getchat-widget__btn--icon\"></div>\r");t.b("\n" + i);if(!t.s(t.f("hideCloseButton",c,p,1),c,p,1,0,0,"")){t.b("        <div class=\"getchat-widget__btn getchat-widget__btn--action-close getchat-widget__btn--icon\">\r");t.b("\n" + i);t.b("          <i aria-hidden=\"true\" class=\"getchat-widget__icon--close\"></i>\r");t.b("\n" + i);t.b("        </div>\r");t.b("\n" + i);};t.b("      </div>\r");t.b("\n" + i);t.b("    </div>\r");t.b("\n" + i);t.b("    <iframe src=\"");t.b(t.v(t.f("widgetUrl",c,p,0)));t.b("\" class=\"getchat-widget__frame\" onload=\"gettour.stopLoading()\"></iframe>\r");t.b("\n" + i);t.b("  </div>\r");t.b("\n" + i);t.b("  <div class=\"getchat-widget__launcher\">\r");t.b("\n" + i);t.b("    <div class=\"getchat-widget__launcher-content\">\r");t.b("\n" + i);t.b("      <div class=\"getchat-widget__launcher__disk getchat-widget__launcher__disk-1\"></div>\r");t.b("\n" + i);t.b("      <div class=\"getchat-widget__launcher__disk getchat-widget__launcher__disk-2\"></div>\r");t.b("\n" + i);t.b("      <div class=\"getchat-launch-logo\">\r");t.b("\n" + i);t.b("        <div></div>\r");t.b("\n" + i);t.b("        <div></div>\r");t.b("\n" + i);t.b("        <div></div>\r");t.b("\n" + i);t.b("        <div></div>\r");t.b("\n" + i);t.b("        <div></div>\r");t.b("\n" + i);t.b("      </div>\r");t.b("\n" + i);t.b("    </div>\r");t.b("\n" + i);t.b("  </div>\r");t.b("\n" + i);t.b("</div>\r");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "<div class=\"getchat-widget__wrapper\">\r\n  <div class=\"getchat-widget__content\">\r\n    <div class=\"getchat-widget__header\" style=\"{{ styles.header }}\" >\r\n      <div class=\"getchat-widget__header-ava\"><img src=\"/img/unknown_ava.jpg\" alt=\"widget avatar\"></div>\r\n      <div class=\"getchat-widget__header-actions\">\r\n        <div class=\"getchat-widget__btn getchat-widget__btn--action-menu getchat-widget__btn--icon\"></div>\r\n        {{^hideCloseButton}}\r\n        <div class=\"getchat-widget__btn getchat-widget__btn--action-close getchat-widget__btn--icon\">\r\n          <i aria-hidden=\"true\" class=\"getchat-widget__icon--close\"></i>\r\n        </div>\r\n        {{/hideCloseButton}}\r\n      </div>\r\n    </div>\r\n    <iframe src=\"{{ widgetUrl }}\" class=\"getchat-widget__frame\" onload=\"gettour.stopLoading()\"></iframe>\r\n  </div>\r\n  <div class=\"getchat-widget__launcher\">\r\n    <div class=\"getchat-widget__launcher-content\">\r\n      <div class=\"getchat-widget__launcher__disk getchat-widget__launcher__disk-1\"></div>\r\n      <div class=\"getchat-widget__launcher__disk getchat-widget__launcher__disk-2\"></div>\r\n      <div class=\"getchat-launch-logo\">\r\n        <div></div>\r\n        <div></div>\r\n        <div></div>\r\n        <div></div>\r\n        <div></div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n", H);return T.render.apply(T, arguments); };
