...
function isElementHidden(el) {
  return _typeof(el) === 'object' && el.offsetParent === null;
}
...
var onboarding = {
  ...
  init: function init(hash) {
    ...
    this.loadWidgetData().then(function (data) {
      ...
      _this.options = Object.assign(_this.options, data.widget_options);
  ...
  highlight: function highlight(_ref2) {
    ...
    this.__intro._options.steps = false; // Add step
  ...
  renderWidget: function renderWidget(widgetUrl, asExpanded) {
    ...
    if (this.options.preview) {
      this.block.className = "".concat(this.block.className, " ").concat(this.block.className, "--preview");
  ...
  initSystemEventListeners: function initSystemEventListeners() {
    ...
    $closeBtn.addEventListener('click', function () {
      if (widget.classList.contains(_this5.expandClass)) {
        _this5.hideBlock();
      }
    });
    $menuBtn.addEventListener('click', function () {
      _this5.showAvailableBots();
    });
    ...
    window.addEventListener('beforeunload', function () {
      clearInterval(_this5.ConditionEventsListeners.interval);
  ...
  showAvailableBots: function showAvailableBots() {
    ...
    var answers = this.ConditionEventsListeners.filterByPath(this.autoShowConditions, true).map(function (uuid) {
      ...
      var _this6$autoShowCondit = _this6.autoShowConditions[uuid],
          bot_id = _this6$autoShowCondit.bot_id,
          name = _this6$autoShowCondit.name,
          start = _this6$autoShowCondit.start;
      return {
        answer: {
          answer_id: answer_id,
          bot_id: bot_id,
