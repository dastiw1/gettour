...
var onboarding = Object.assign({
  ...
  renderWidget: function renderWidget(chatUrl, asExpanded) {
    ...
    var frame = document.querySelector('.getchat-widget__frame'); // appending overlay
    ...
    this.overlay = overlay; // Авторасскрытие
