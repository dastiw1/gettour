  ...
  _createClass(ConditionEventsListeners, [{
    ...
    value: function start() {
      ...
      Object.keys(this.autoConditions).forEach(function (uuid) {
        ...
        if (_this3.active !== uuid && regex.test(window.location.pathname)) {
    ...
    value: function matchDate(cond) {
      return this.isMatchDateCondition(this.metrics.siteEnterTime, cond.time_on_page) && this.isMatchDateCondition(this.metrics.pageEnterTime, cond.time_on_page);
    }
  }, {
    key: "clickListener",
